...
$photos = $con->query("SELECT photo, title ,photo_date 
  FROM photo
  ORDER BY photo_date DESC")->fetchAll();


if (!empty($photos)) {
  echo '<div class="row tm-mb-90 tm-gallery">';
  foreach ($photos as $image) {
    // ... (your existing code to display photos)
  }
  echo '</div>';
} else {
  // Display a message if no photos found
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <?php foreach ($photos as $image): ?>
            ...
            <figure class="effect-ming tm-video-item">
                <a href="photo-detail.php?id=<?php echo $image['photo']; ?>">
                <img src="<?php echo $image['photo']; ?>" alt="Image" class="img-fluid">
                </a>
